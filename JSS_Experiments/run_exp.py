...
plt.scatter(X[:, 0], X[:, 1])
plt.axis("equal")
plt.savefig('./double-circles-scatterplot.pdf')
plt.close()
...
plt.axis("equal")
plt.savefig('./double-circles-psc-cluster.pdf')
plt.close()

X, y = datasets.make_moons(n_samples=n_samples, noise=0.05)
plt.scatter(X[:, 0], X[:, 1])
plt.axis("equal")
plt.savefig('./double-moons-scatterplot.pdf')
plt.close()
...
plt.scatter(X[:, 0], X[:, 1], c=y_pred, cmap="rainbow")
plt.axis("equal")
plt.savefig('./double-moons-psc-cluster.pdf')
plt.close()
